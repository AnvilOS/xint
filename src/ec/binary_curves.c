...
const xword_t k409_a[]  = { X(0x00000000, 0x00000000), X(0x00000000, 0x00000000), X(0x00000000, 0x00000000), X(0x00000000, 0x00000000), X(0x00000000, 0x00000000), X(0x00000000, 0x00000000), 0x00000000 };
const xword_t k409_b[]  = { X(0x00000000, 0x00000000), X(0x00000000, 0x00000000), X(0x00000000, 0x00000000), X(0x00000000, 0x00000000), X(0x00000000, 0x00000000), X(0x00000000, 0x00000000), 0x00000000 };
...
const xword_t k409_n[]  = { X(0xe01e5fcf, 0x4b5c83b8), X(0xe3e7ca5b, 0x557d5ed3), X(0x20400ec4, 0x83b2d4ea), X(0xfffffe5f, 0xffffffff), X(0xffffffff, 0xffffffff), X(0xffffffff, 0xffffffff), 0x7fffff };
const xword_t k409_h[]  = { 0x04 };
const int k409_exp[] = { 87, 0 };
const xword_t k409_x[]  = { X(0x00000001, 0x00000000), X(0x00800000, 0x00000000), X(0x00000000, 0x00000000), X(0x00000000, 0x00000000), X(0x00000000, 0x00000000), X(0x00000000, 0x00000000), 0x02000000 };
